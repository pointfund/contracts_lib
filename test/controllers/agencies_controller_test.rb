...
class AgenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agency" do
    assert_difference('Agency.count') do
      post agencies_url, params: { agency: { agt_busi_name: @agency.agt_busi_name, agt_name: @agency.agt_name, agt_num: @agency.agt_num } }
    end
  ...
  test "should update agency" do
    patch agency_url(@agency), params: { agency: { agt_busi_name: @agency.agt_busi_name, agt_name: @agency.agt_name, agt_num: @agency.agt_num } }
